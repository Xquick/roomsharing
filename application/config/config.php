...
|	4 = All Messages
|
| For a live site_c.php you'll usually only enable Errors (1) to be logged otherwise
...
|
*/
$config['encryption_key'] = 'ksazdhelskrtep';
...
| 'cookie_domain' = Set to .your-domain.com for site_c.php-wide cookies
